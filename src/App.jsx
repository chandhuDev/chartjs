...
function App() {
 ...
 function submitData(e){
  ...
  return (
    <>
      <div className='flex w-full h-screen bg-indigo-600/80 flex-col justify-start items-center'>
      ...
      onKeyUp={submitData}
      />
      <button onClick={sort} className='transition px-4 py-2 text-white font-semibold rounded-lg ease-in-out delay-50 bg-gray-700/80 hover:-translate-y-1 hover:scale-110 hover:bg-gray-700/80 duration-300'>Sort</button>
      </div>  
      <div className='md:w-3/5 md:h-3/5 w-ful h-auto rounded-md bg-white mt-14 shadow-xl cursor-pointer'>
